...
# Output:
# TEI: single or multiple TE insertion
# TEA: Alternative TE
# VNTR: deletion or insertion of satellite repeat or simple repeat
# NAHR: >100bp homology
# alt-EJ: 3-100bp homology
# NHEJ: 0-2bp homology
# FoSTeS: template switch, >10bp insertion at deletion break points
...
&print_usage unless (defined($opts{i}) and defined($opts{R}));
